...
namespace YZNotepadClone
{
    public partial class Main : Form
    {
        ...
        public void Open(string pFilename, Encoding encoding = null)
        {
            ...
            if (!File.Exists(Filename))
            {
                ...
                if (!FileExists)
                {
                    ...
                    var Result = MessageBox.Show(Message, "YZ Notepad Clone", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Warning);
        ...
        private void menuitemFilePrint_Click(object IGNORE_sender, EventArgs IGNORE_e)
        {
            ...
            PrintDocument.DocumentName = DocumentName + " - YZ Notepad Clone";
        ...
        private void menuitemEditFindNext_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(this, CONST.CannotFindMessage.FormatUsingObject(new { SearchText = _LastSearchText }), "YZ Notepad Clone");
            }
        }
