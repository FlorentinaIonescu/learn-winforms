    ...
    public partial class GoToLinePrompt : Form {
        ...
        private void buttonGoTo_Click(object sender, EventArgs e) {
            if (controlLineNumberTextBox.Text.IsEmpty()) {
                MessageBox.Show(this, "You must enter a value.", "YZ Notepad Clone - Goto Line");
                return;
            }
            ...
            if (PotentialLineNumber == 0) {
                MessageBox.Show(this, "Zero (0) is not a valid line number, line numbers start at 1.", "YZ Notepad Clone - Goto Line");
                return;
            }
        ...
        private void controlLineNumberTextBox_KeyPress(object sender, KeyPressEventArgs e) {
            if (!char.IsDigit(e.KeyChar)) {
                ...
                controlToolTip.Show("Unacceptable Character - You can only type a number here.", Sender);
                e.Handled = true;
            }
        }
